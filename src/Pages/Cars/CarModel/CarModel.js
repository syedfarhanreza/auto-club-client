...
const CarModel = ({ car, setCarName, users }) => {
    console.log(car);
   if(users === 'buyer'){
    return (
            ...
            <div className="hero-content flex-col lg:flex-row">
                ...
                <div>
                    ...
                    <div className='flex justify-between'>
                        ...
                        <div>
                        <Link> <button className="btn btn-outline hover:bg-[#ff4605] banner-title">Wishlist</button></Link>
                        </div>

                        <div>
                            <Link> <button className="btn btn-outline hover:bg-[#ff4605] banner-title">More Details</button></Link>
                        </div>
                    </div>
                </div>
            </div>
